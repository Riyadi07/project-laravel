...
<!-- HERO SECTION -->
    ...
    <section
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="relative z-30 text-center max-w-2xl mx-auto mb-6">
                <span class="text-lg font-bold uppercase tracking-widest text-blue-400">Kenali Saya</span>
                <h2 class="text-3xl font-extrabold text-white sm:text-4xl">Tentang saya.</h2>
                <p class="text-base text-slate-400 mt-2">Sedikit cerita tentang latar belakang dan minat saya di dunia teknologi.</p>
            </div>
                ...
                <div class="lg:col-span-7 space-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="rounded-xl border border-slate-800 bg-slate-950/40 p-4">
                            ...
                            <p class="text-xs text-slate-400 mt-0.5 mb-5">Universitas Jenderal Achmad Yani</p>
                            <p class="mt-1 text-base font-bold text-white">SMA Negri 1 Semaka</p>
  ...
  <!-- SKILLS SECTION -->
    <section
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="text-center max-w-2xl mx-auto mb-6">
                <span class="text-lg font-bold uppercase tracking-widest text-blue-400">Skills</span>
                <h2 class="text-3xl font-extrabold text-white sm:text-4xl">Teknologi yang saya gunakan.</h2>
    ...
    <section
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="text-center max-w-2xl mx-auto mb-6">
                <!-- <span class="text-lg font-bold uppercase tracking-widest text-blue-400">Projects</span> -->
                <h2 class="text-3xl font-extrabold text-white sm:text-4xl">Projects</h2>
                <p class="text-base text-slate-400 mt-2">
    ...
    >
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div class="text-center max-w-2xl mx-auto mb-10 sm:mb-12">
                ...
                <h2 class="text-3xl font-extrabold text-white sm:text-4xl mt-1">Mari Bekerja Sama.</h2>
            ...
            <div class="grid gap-8 lg:grid-cols-12 items-start">
                ...
                <div class="lg:col-span-5 space-y-4">
                    ...
                    <!-- Email Card -->
                    <a href="mailto:emailkamu@gmail.com" class="group flex items-center gap-4 rounded-2xl border border-slate-800/80 bg-slate-950/40 p-4 sm:p-5 backdrop-blur-md transition duration-300 hover:border-blue-500/50 hover:bg-slate-900/60">
                        <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-blue-500/30 bg-blue-600/10 text-blue-400 transition duration-300 group-hover:scale-110 group-hover:bg-blue-600 group-hover:text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="h-6 w-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                            </svg>
                        </div>
                        <div>
                            <p class="text-xs font-semibold uppercase tracking-wider text-blue-400">Email</p>
                            <p class="text-sm sm:text-base font-bold text-white group-hover:text-blue-300 transition">riyadiputrar@gmail.com</p>
                        </div>
                    </a>

                    <!-- Instagram Card -->
                    <a href="https://instagram.com/riyadii0_" target="_blank" rel="noopener noreferrer" class="group flex items-center gap-4 rounded-2xl border border-slate-800/80 bg-slate-950/40 p-4 sm:p-5 backdrop-blur-md transition duration-300 hover:border-pink-500/50 hover:bg-slate-900/60">
                        <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-pink-500/30 bg-pink-600/10 text-pink-400 transition duration-300 group-hover:scale-110 group-hover:bg-pink-600 group-hover:text-white">
                            {{-- SVG Icon Instagram --}}
                        ...
                        <div>
                            <p class="text-xs font-semibold uppercase tracking-wider text-pink-400">Instagram</p>
                            <p class="text-sm sm:text-base font-bold text-white group-hover:text-pink-300 transition">@riyadii0_</p>
                        </div>
                    </a>
                    <!-- Location Card -->
                    <div class="flex items-center gap-4 rounded-2xl border border-slate-800/80 bg-slate-950/40 p-4 sm:p-5 backdrop-blur-md">
                        <div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-indigo-500/30 bg-indigo-600/10 text-indigo-400">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="h-6 w-6">
                        ...
                        <div>
                            <p class="text-xs font-semibold uppercase tracking-wider text-indigo-400">Lokasi</p>
                            <p class="text-sm sm:text-base font-bold text-white">Yogyakarta, Indonesia</p>
                        </div>
                    </div>
            ...
            <div class="lg:col-span-7 rounded-3xl border border-slate-800/80 bg-slate-950/50 p-6 sm:p-8 backdrop-blur-md">
                <form id="contact-form" action="https://formspree.io/f/myegrjkj" method="POST" autocomplete="off" class="space-y-4">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <!-- Input Nama -->
                        <div>
                            <label for="contact-name" class="block text-xs font-semibold text-slate-300 uppercase tracking-wider mb-2">Nama Anda</label>
                            <input 
                                type="text" 
                                name="name"
                                id="contact-name" 
                                ...
                                class="w-full rounded-xl border border-slate-800 bg-slate-900/90 px-4 py-3 text-sm text-white placeholder-slate-500 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 transition"
                            >
                        </div>

                        <!-- Input Email -->
                        <div>
                            <label for="contact-email" class="block text-xs font-semibold text-slate-300 uppercase tracking-wider mb-2">Email Anda</label>
                            <input 
                                type="email" 
                                name="email"
                                id="contact-email" 
                    ...
                    <!-- Input Pesan -->
                    <div>
                        <label for="contact-message" class="block text-xs font-semibold text-slate-300 uppercase tracking-wider mb-2">Pesan</label>
                        <textarea 
                            name="message"
                            id="contact-message" 
                            rows="4" 
                            ...
                            class="w-full rounded-xl border border-slate-800 bg-slate-900/90 px-4 py-3 text-sm text-white placeholder-slate-500 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 transition custom-scrollbar"
                        ></textarea>
                    </div>
                    ...
                    <button 
                        ...
                        class="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-6 py-3.5 text-sm font-semibold text-white shadow-lg shadow-blue-600/30 transition duration-300 hover:bg-blue-500 hover:shadow-blue-500/50 hover:-translate-y-0.5 active:translate-y-0 disabled:opacity-50"
                    >
            ...
            <div id="contact-modal" class="fixed inset-0 z-[70] flex items-center justify-center bg-slate-950/80 backdrop-blur-md opacity-0 pointer-events-none transition-all duration-300 p-4">
                <div class="relative w-full max-w-sm rounded-3xl border border-slate-800 bg-slate-950/95 p-6 text-center shadow-2xl text-white transform transition-all duration-300 scale-95">
                    
                    {{-- Icon Notifikasi --}}
                    <div id="contact-modal-icon" class="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl">
                        <!-- Icon akan diisi oleh JavaScript -->
                    </div>

                    {{-- Judul & Pesan --}}
                    <h3 id="contact-modal-title" class="text-xl font-bold text-white"></h3>
                    <p id="contact-modal-message" class="mt-2 text-xs sm:text-sm text-slate-300 leading-relaxed"></p>

                    {{-- Tombol OK --}}
                    <button 
                        type="button" 
                        onclick="closeContactModal()" 
                        class="mt-6 w-full rounded-xl bg-blue-600 px-5 py-2.5 text-xs font-semibold text-white transition hover:bg-blue-500 shadow-lg shadow-blue-600/30"
                    >
                        OK
                    </button>
                    </div>
...
{{-- MODAL DETAIL PROJECT (SUPER RESPONSIF MOBILE & DESKTOP) --}}
<div id="project-modal" class="fixed inset-0 z-[60] flex items-center justify-center bg-slate-950/85 backdrop-blur-md opacity-0 pointer-events-none transition-all duration-300 p-2.5 sm:p-6">    
    {{-- Kontainer Modal: Disesuaikan max-w dan max-h untuk HP --}}
    <div class="relative flex flex-col w-full max-w-sm sm:max-w-2xl lg:max-w-3xl max-h-[82vh] sm:max-h-[88vh] rounded-2xl sm:rounded-3xl border border-slate-800 bg-slate-950/95 shadow-2xl overflow-hidden text-white my-auto">        
        <button onclick="closeProjectModal()" class="absolute top-2.5 right-2.5 sm:top-4 sm:right-4 z-40 flex h-7 w-7 sm:h-9 sm:w-9 items-center justify-center rounded-full bg-slate-900/90 text-slate-300 hover:bg-blue-600 hover:text-white border border-slate-700/80 transition shadow-xl text-xs sm:text-base">
            ✕
        </button>
        {{-- Header / Carousel Gambar (Tinggi Ringkas di HP) --}}
        <div class="relative w-full aspect-[16/10] sm:aspect-[21/9] max-h-[180px] sm:max-h-[280px] bg-slate-900 border-b border-slate-800 shrink-0 group overflow-hidden">
            <img id="modal-carousel-img" src="" class="w-full h-full object-cover transition-all duration-300">
            {{-- Tombol Next/Prev Carousel --}}
            <button id="modal-prev-btn" onclick="prevCarouselImage()" class="absolute left-2 sm:left-3 top-1/2 -translate-y-1/2 flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-full bg-slate-950/80 text-white border border-slate-700 opacity-0 group-hover:opacity-100 transition z-30 text-xs sm:text-sm">❮</button>
            <button id="modal-next-btn" onclick="nextCarouselImage()" class="absolute right-2 sm:right-3 top-1/2 -translate-y-1/2 flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-full bg-slate-950/80 text-white border border-slate-700 opacity-0 group-hover:opacity-100 transition z-30 text-xs sm:text-sm">❯</button>
            {{-- Indicator Dots --}}
            <div id="modal-carousel-dots" class="absolute bottom-2 inset-x-0 flex justify-center gap-1 z-30"></div>
        </div>

        {{-- Area Deskripsi & Info (Internal Scroll) --}}
        <div class="flex-1 overflow-y-auto p-4 sm:p-6 space-y-3 sm:space-y-4 custom-scrollbar">
            <div>
                <h3 id="modal-title" class="text-lg sm:text-2xl font-bold text-white pr-6"></h3>
                <p id="modal-description" class="mt-1.5 text-xs sm:text-sm leading-relaxed text-slate-300 whitespace-pre-line"></p>
            </div>
            {{-- Bahasa & Teknologi --}}
            <div>
                <p class="text-[10px] sm:text-xs font-semibold uppercase tracking-wider text-blue-400 mb-1.5 sm:mb-2">Bahasa & Teknologi:</p>
                <div id="modal-technologies" class="flex flex-wrap gap-1.5 sm:gap-2"></div>
            </div>
        </div>

        {{-- Footer Link GitHub --}}
        <div class="p-3 sm:p-5 border-t border-slate-800 bg-slate-950 shrink-0 flex flex-wrap gap-2 sm:gap-3">
            <a id="modal-github" href="#" target="_blank" class="hidden inline-flex items-center gap-1.5 sm:gap-2 rounded-xl border border-slate-800 bg-slate-900 px-3 py-2 sm:px-4 sm:py-2.5 text-[11px] sm:text-xs font-semibold text-slate-200 hover:border-slate-700 hover:bg-slate-800 transition">
                <i class="devicon-github-original text-sm sm:text-base"></i> View Code on GitHub
            </a>
        </div>
    </div>
</div>